...
namespace Physics {
    ...
    public:
        ...
        std::pair<glm::vec2, glm::vec2> get_collision_point_and_normal(const CircleCollider& other) const;
    ...
    public:
        ...
        std::pair<glm::vec2, glm::vec2> get_collision_point_and_normal(const PolygonCollider& other) const;
        bool is_colliding(glm::vec2 ray_start, glm::vec2 ray_point) const;
