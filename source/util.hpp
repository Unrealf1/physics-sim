...
Physics::SimulationObject create_sim_object(glm::vec2 position, glm::vec2 velocity, float radius, float mass) {
...
Physics::SimulationCircle create_sim_circle(glm::vec2 position, glm::vec2 velocity, float radius, float mass) {
